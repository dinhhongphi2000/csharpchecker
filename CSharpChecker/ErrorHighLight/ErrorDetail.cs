...
namespace CSharpChecker.ErrorHighLight
{
    class ErrorDetail
    {
        ...
        public ErrorDetail(SnapshotSpan span, IReadOnlyList<string> alternateSpellings)
        {
            this.Span = span;
        ...
        public static ErrorDetail Clone(ErrorDetail error)
        {
            return new ErrorDetail(error.Span, error.AlternateSpellings);
        }

        public static ErrorDetail CloneAndTranslateTo(ErrorDetail error, ITextSnapshot newSnapshot)
        {
            ...
            return (newSpan.Length == error.Span.Length)
                   ? new ErrorDetail(newSpan, error.AlternateSpellings)
                   : null;
        }
    }
}
