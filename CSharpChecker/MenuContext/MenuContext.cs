...
namespace CSharpChecker.MenuContext
{
    /// <summary>
    /// Command handler
    /// </summary>
    internal sealed class MenuContext
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("ef091b9f-497c-46bc-990e-a5a93ab0ec97");
        ...
        private MenuContext(AsyncPackage package, OleMenuCommandService commandService)
        {
